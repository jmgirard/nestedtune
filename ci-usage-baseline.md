...
Window `[2026-07-26T00:00:00Z, 2026-07-27T07:00:00Z)`, runs with status
`completed`. Default branch `main`.

Path filter read from R-CMD-check.yaml, test-coverage.yaml: `cairn/**`,
`CLAUDE.md`, `.claude/**`
