...
time_budget_ledger <- function() {
  rbind(
    ...
    tb_row("test-parallel-classify.R", 520L, "start_daemons",
           START_DAEMONS_BOUND_S(),
           "dispatch accepts daemons primed with the package"),
    tb_row("test-parallel-classify.R", 527L, "daemons_load_status", 60,
           "dispatch accepts daemons primed with the package",
    ...
    tb_row("test-parallel-payload.R", 180L, "start_daemons",
           START_DAEMONS_BOUND_S(),
