...
- 2026-09-01: correction to the line above — the post-fix `devtools::test()` count is PASS 2691, not 2703 (a slip in transcription; the log reads FAIL 0, WARN 0, SKIP 0, PASS 2691), and `devtools::check()` took 4m 30s.
