...
- 2026-09-05: step-7 approval: PR #73 approved for merge; the branch is pushed once here (checkpoints held local since the PR push per the M50 lesson), CI re-run on the fixed article, the pkgdown log re-read for AC1's CI half before the merge.
