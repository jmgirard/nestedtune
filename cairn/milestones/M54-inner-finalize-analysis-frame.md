...
- [ ] T2: `analysis_framed_inner(inner, split)` in `R/nested-resamples.R` beside
...
- [ ] T3: Roxygen on the three `@param param_info` sites and `?nested_final_fit`'s `@param results`;
