...
#'   its `inner_resamples` column an `rset` per outer fold. Both are
#'   checked before anything is fitted: [rsample::nested_cv()] will build a
#'   design whose inner specification produced neither, and such a design cannot
#'   be run.
