...
each fold chose. `nested_final_fit()` takes that result and runs the procedure
it recorded once more with the whole dataset in hand, and gives back the model
to deploy as its own object.
